...
<div class="body-title">
	<a href="controller?command=go_to_news_list"><c:out	value="${addnews_name}" />&rarr; </a>	<c:out value="${addnews_addnews}" />
</div>
			...
			<tr>
				...
				<td class="space_around_view_text"><div class="word-breaker">
						<input type="text" name="news_title"
							value="Title"<c:out value="${requestScope.news.title }"/>" />
					</div></td>
			</tr>
			...
			<tr>
				...
				<td class="space_around_view_text"><div class="word-breaker">
						<input type="text" name="news_brief"
							value="Brief"<c:out value="${requestScope.news.briefNews }"/>" />
					</div></td>
			</tr>
			<tr>
